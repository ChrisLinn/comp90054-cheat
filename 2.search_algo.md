...
+ Greedy Best-First Search
    * 1/3 popular in satisﬁcing planning
...
+ A*
    * most popular in optimal planning, rarely used in satisﬁcing planning
...
+ en h c
    * no iptimal
    * no generally NO complte, yes under particular circu   h goal-aware
